...
JNIEXPORT jint JNICALL Java_com_zoson_vision_activity_MainActivity_liveinit(JNIEnv *env,
                                                                             jclass obj,
...
JNIEXPORT jint JNICALL Java_com_zoson_vision_activity_MainActivity_livestart(JNIEnv *env,
                                                                              jclass obj,
                                                                              jbyteArray yuvdata) {
